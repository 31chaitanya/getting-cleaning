...
colnames(act_label) <- c("Activity", "Activity Name")
datav1 <- cbind(y_merge,subject_merge, extract)
...
datav2cast[, Activity := NULL]
setcolorder(datav2cast, c("Activity Name", setdiff(names(datav2cast),"Activity Name")))
